...
| DQ-05 | Diagnosticar y resolver (o documentar) el crossref infobras↔ejecución vacío | Causa raíz documentada; si es corregible en ≤M, el crossref se repuebla; si no, ticket de seguimiento fuera de este backlog | — | P0 | M (puede escalar a L) | ⬜ Pendiente |
