...
### DQ-18 · Bloque grande de obras de Ica (Nazca/Chincha/Pisco/Palpa) mal etiquetado como HUANCAVELICA en INFOBRAS
...
- **Criterios de aceptación:**
  - Decidir si corregir el `departamento` de estas 889 filas (reclasificarlas a ICA) en un paso de post-procesamiento del ingest, o dejarlas como están y depender de `distrito_sospechoso` para que los consumidores las excluyan — **no se decidió en esta sesión**, es una decisión de producto (¿corregimos el dato de la fuente o solo lo señalizamos?), no solo técnica.
