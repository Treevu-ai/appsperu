...
**Nota al mergear PR #145 (2026-09-14):** esta decisión de alcance es la respuesta real al ítem sin
marcar en el test plan del PR #145 ("corrida de las 23 regiones restantes... se documentará por
separado"). Nunca se completaron las 23 — el batch se detuvo deliberadamente en HUANUCO por las
razones de arriba. Solo 6 de los 23 departamentos adicionales (ANCASH, APURIMAC, AYACUCHO,
CAJAMARCA, CUSCO, HUANCAVELICA) tienen ingesta real vía CT-10; AMAZONAS y CALLAO fallaron; el resto
nunca se corrió. El alcance de ejecución activa del producto quedó en LA LIBERTAD/AREQUIPA/LIMA.
...
- **DQ-06 a DQ-17 y SI-09** (`docs/TICKETS_Calidad_Datos_Auditoria_La_Libertad_v1.md`): batch de
  ...
  institucional, sin pesar). DQ-17 queda pendiente, sin resolver esta sesión (cerrado más tarde,
  ver PR #144, 2026-09-14).
