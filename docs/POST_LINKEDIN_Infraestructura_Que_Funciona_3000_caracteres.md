Una obra no mejora una ciudad cuando se aprueba su presupuesto. La mejora empieza cuando una persona puede usarla.
...
Cada flecha cambia la conversación. Un CUI puede identificar una inversión. Una obra puede reportar avance. Pero ninguna de esas dos cosas demuestra que fue recibida, que alguien la opera, que tiene mantenimiento o que el servicio está disponible. Confundir esos momentos explica por qué podemos celebrar ejecución sin saber si el beneficio llegó al aula, al canal, a la calle o al hogar.
...
Éste es un cambio de estándar. En vez de preguntar solo “¿cuánto se gastó?”, podemos preguntar: ¿quién recibió el activo y en qué fecha?, ¿quién lo opera y quién responde por su mantenimiento?, ¿qué indicador público demuestra que presta el servicio prometido?

Una entidad que ejecuta bien debería poder responder con documentos, fechas, responsables y resultados publicados. La evidencia también sirve para demostrar buena gestión.

La mejor fiscalización ciudadana no reemplaza explicaciones con prejuicios. Exige explicaciones mejores. Si la infraestructura funciona, los datos deben ayudar a demostrarlo. Si falta información, el mismo grafo ayuda a pedirla con precisión.

El siguiente paso para hablar seriamente de desarrollo no es contar obras como trofeos. Es seguir servicios que las personas puedan usar.
