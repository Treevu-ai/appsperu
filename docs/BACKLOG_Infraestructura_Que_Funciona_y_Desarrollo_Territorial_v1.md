...
| IF-07–11 | Modelo hecho; evidencia pendiente, verificada de nuevo | Cierre, operador, mantenimiento, disponibilidad y cola append-only operan. La cohorte conserva cero registros de esos tipos y ocho vacíos pendientes. **Verificación en vivo 2026-09-05** (foco La Libertad, sin ampliar a otras regiones): búsqueda en prensa/fuentes oficiales no encontró evidencia nueva que cierre ninguno de los 8 vacíos; se registró el evento de revisión (`NEEDS_EVIDENCE`) para cada uno y se agregó un dato de avance físico más reciente del drenaje de Trujillo (0%, entrega reprogramada a mayo 2035 — La República, 2026-08-17). Ver `apps/radar-ejecucion/api/src/db/migrations/019_if_sc_verificacion_2026-09-05.sql`. |
| IF-12–13 | Modelo hecho; primeros dos indicadores cargados (2026-09-06) | Se modeló servicio/cobertura y se prohíbe convertirlo en impacto económico o social. Casa Grande: 900 estudiantes beneficiados (mismo comunicado de ANIN ya citado como fuente del activo, sin ambigüedad). Drenaje Trujillo: 250,000 habitantes, con caveat explícito — cifra de 2023 (ARCC, antecesora de ANIN en el proyecto), sin confirmación posterior de que siga vigente. Ver `apps/radar-ejecucion/api/src/db/migrations/021_if12_indicadores_servicio_2026-09-06.sql`. |
