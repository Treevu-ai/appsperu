...
| **Cruces** | Ninguno implementado todavía — candidato natural: mismo RUC/DNI contra `inhabilitaciones`/`multas` (Tribunal de Contrataciones) de esta misma app, para distinguir inhabilitación judicial vs. administrativa por proveedor. |
