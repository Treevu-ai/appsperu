...
/**
 * Selecciona la última versión de cada observación lógica. No usa un MAX
 * global: una cobertura regional/local puede tener un corte distinto de la
 * cobertura nacional dirigida al mismo departamento.
 */
