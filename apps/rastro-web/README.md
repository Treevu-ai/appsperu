...
**<!-- COUNT:TOOL_COUNT -->154<!-- /COUNT --> tools MCP** de las <!-- COUNT:APP_COUNT -->28<!-- /COUNT -->
...
es la capa de lectura visual para humanos — con dashboard propio hoy para 14 de esas 28 apps (`api-client.ts`),
...
- **MCP:** <!-- COUNT:TOOL_COUNT -->154<!-- /COUNT --> tools de solo lectura, transporte stdio
