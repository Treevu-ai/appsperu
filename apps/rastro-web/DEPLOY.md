...
- `index.html` — JSON-LD con `Organization`, `WebSite` y `SoftwareApplication` (este último para que AI crawlers descubran el MCP server con sus <!-- COUNT:TOOL_COUNT -->154<!-- /COUNT --> tools).
