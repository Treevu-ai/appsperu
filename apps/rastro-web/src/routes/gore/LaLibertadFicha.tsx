...
import { ProveedoresRiesgoSection } from "./ProveedoresRiesgoSection.js";
  ...
  return (
    <div>
      ...
      <p className="text-xs text-muted mt-0.5">
        {totals.entidades} entidad(es) verificada(s)
      </p>
